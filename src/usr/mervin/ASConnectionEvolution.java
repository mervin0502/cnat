...
public class ASConnectionEvolution {
	...
	public void clusterCofficient(){
		...
		for(int i = 1; i <= 48; i++){
			...
			net = new Network(srcFile, NetType.INDIRECTED, this.numberType);
			this.ft.write(cc.nodesClusterCofficient(net, net.getAllNodeId()), "../data/AS-2009-2012/CC/"+i+"-cc.txt");
		}
	}
	/*
	 ********************************************************************************
...
//				D.p("core size:"+al.size());
	 ...
	 * 内部连接的抖动
	 */
	public void connectionJitter(String type){
		String dir = null;
		...
		for(int i = 1; i <= 47; i++){
			...
			this.ft.write(sb1, this.dstDir+"jitter/"+type+"/"+dir+"-living.txt");
			this.ft.write(sb2, this.dstDir+"jitter/"+type+"/"+dir+"-jitterFreq.txt");
			this.ft.write(sb3, this.dstDir+"jitter/"+type+"/"+dir+"-jitter.txt");
			this.ft.write(sb4, this.dstDir+"jitter/"+type+"/"+dir+"-timeliness.txt");
			this.ft.write(sb5, this.dstDir+"jitter/"+type+"/"+dir+"-continuning.txt");
