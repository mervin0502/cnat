 ...
 *  @version 0.4.0
 */
public class PFP extends AbstractModel {
	 ...
	 *  @param q
	 */
	public void setParam(int addNodeNum, double p, double q){
	 ...
	 *  @param s 
	 */
	public void setParam(int addNodeNum, double p, double q, double s){
		this.addNodeNum = addNodeNum;
		this.p = p;
		this.q = q;
		this.r = 1 - p -q;
