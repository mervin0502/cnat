...
public class NWNetwork extends AbstractModel {
	 ...
	 * @param p
	 */
	public void setNetParam(int addNodeNum, int k, double p){
		this.addNodeNum = addNodeNum;
		this.k = k;
		this.p = p;
	}
	public void setNetParam(int startNodeId, int addNodeNum, int k, float p){
