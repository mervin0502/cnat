...
public class LocalWorldEvolvingNet extends AbstractModel {
	...
	private HashMap<Number, Number> degreeMap = null;
	 ...
	 * @param m
	 */
	public void setNetParam(int addNodeNum, int M, int m){
	 ...
	 *  createModelNetwork
	 *  网络模型构造函数
	 * @see core.AbstractModel#createModelNetwork()
	 */
	@Override
	public void createModelNetwork() {
		...
		for (int i = 0; i < addNodeNum; i++) {
			...
			for (int j = 0; j < this.m; j++) {
				oldNodeId = this.prioritySelectionFun(newNodeId);
	...
	public Number prioritySelectionFun(Number nodeId){
