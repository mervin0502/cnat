...
public final class GloballyCoupledNet extends AbstractModel {
	 ...
	 * @param addNodeNum
	 */
	public void setNetParam(int addNodeNum){
	 ...
	 * @param addNodeNum
	 */
	public void setNetParam(int startNodeId, int addNodeNum){
