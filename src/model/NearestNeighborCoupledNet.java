...
public class NearestNeighborCoupledNet extends AbstractModel {
	 ...
	 * @param k
	 */
	public void setNetParam(int addNodeNum, int k){
	 ...
	 * @param k
	 */
	public void setNetParam(int startNodeId, int addNodeNum, int k){
