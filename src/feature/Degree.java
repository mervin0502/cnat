...
import feature.interfaces.InterfaceDegree;
...
public class Degree implements InterfaceDegree{
	...
	public int nodeDegree(Number nodeId){
		if(this.net.isHasNode(nodeId)){
			return this.net.getAdjNodes(nodeId).size();
		}else{
			return 0;
		}
	}
	...
	public int nodeDegree(Network net, Number nodeId){
		return net.getAdjNodes(nodeId).size();
	}
	...
	public int nodeInDegree(Number nodeId){
		return this.net.getInDegreeNodesId(nodeId).size();
	}
	...
	public int nodeInDegree(Network net, Number nodeId){
		return net.getInDegreeNodesId(nodeId).size();
	}
	...
	public int nodeOutDegree(Number nodeId){
		return this.net.getOutDegreeNodesId(nodeId).size();
	}
	...
	public int nodeOutDegree(Network net, Number nodeId){
		return net.getOutDegreeNodesId(nodeId).size();
	}
