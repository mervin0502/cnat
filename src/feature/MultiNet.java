...
import core.Network;
import feature.interfaces.InterfaceMultiNet;
...
public class MultiNet implements InterfaceMultiNet{
	...
	public Set<Number> intersectionByNode(){
		Set<Number> preNodeIdSet = (Set<Number>) this.preNet.topology.keySet();
		Set<Number> postNodeIdSet = (Set<Number>) this.postNet.topology.keySet();
	...
	public Set<Number> intersectionByNode(Network preNet, Network postNet){
		Set<Number> preNodeIdSet = (Set<Number>) preNet.topology.keySet();
		Set<Number> postNodeIdSet = (Set<Number>) postNet.topology.keySet();
		return MathTool.intersection(preNodeIdSet, postNodeIdSet);
	}
	/**
	 *  birthNodes
	...
	public Set<Number> birthNodes(){
		Set<Number> preNodeIdSet = (Set<Number>) this.preNet.topology.keySet();
		Set<Number> postNodeIdSet = (Set<Number>) this.postNet.topology.keySet();//新网络的节点集
	...
	public Set<Number> birthNodes(Network preNet, Network postNet){
		Set<Number> preNodeIdSet = (Set<Number>) preNet.topology.keySet();
		Set<Number> postNodeIdSet = (Set<Number>)postNet.topology.keySet();//新网络的节点集		
		return MathTool.subtraction(postNodeIdSet, preNodeIdSet);
	}
	...
	public Network intersectionByEdge(){
		...
		HashSet<Number> preAdjNodes = null;
		HashSet<Number> postAdjNodes = null;
		Number preNodeId = 0;
		Number postNodeId = 0;
		boolean flag = false;
	...
	public Network deathByInEdge(){
		...
		HashSet<Number> preAdjNodes = null;
		HashSet<Number> interAdjNodes = null;
		Number preNodeId = 0;
	...
	public Network deathByBoundaryEdge(){
		...
		if(this.deathNodeSet == null){
			this.deathNodeSet = this.deathNodes();
		}
		...
		HashSet<Number> deathAdjNodes = null;
	...
	public Network deathByBoundaryEdge(Network preNet, Network postNet){
		Network net3 = new Network();
		Set<Number> deathNodes = this.deathNodes(preNet, postNet);//死亡节点
		Set<Number> interNodes = this.intersectionByNode(preNet, postNet);	
		HashSet<Number> deathAdjNodes = null;
		Number deathNodeId  = null;
		Number deathAdjNodeId = null;
	...
	public Network birthByBoundaryEdge(){
		...
		if(this.birthNodeSet == null){
			this.birthNodeSet = this.birthNodes();
		}
		...
		HashSet<Number> birthAdjNodes = null;
	...
	public Network birthByBoundaryEdge(Network preNet, Network postNet){
		Network net3 = new Network();
		Set<Number> birthNodes = this.birthNodes(preNet, postNet);//新生节点
		Set<Number> interNodes = this.intersectionByNode(preNet, postNet);	
		HashSet<Number> birthAdjNodes = null;
		Number birthNodeId  = null;
		Number birthAdjNodeId = null;
