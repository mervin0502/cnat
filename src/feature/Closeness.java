...
public class Closeness {
	 ...
	 */
	public HashMap<Number, Number> nodesCloseness(Set<Number> nodesId){
		return this.nodesCloseness(this.net, nodesId);
	}
	/**
	 * 紧密度中心化
	 * @param net
	 ...
	 * @return HashMap<Number, Number>
	 */
	public HashMap<Number, Number> nodesCloseness(Network net, Set<Number> nodesId){
	 ...
	 *  @return HashMap<Number, Number>
	 */
	public HashMap<Number, Number> netCloseness(Network net){
		HashMap<Number, Number> nodesCloseness = new HashMap<Number, Number>();
